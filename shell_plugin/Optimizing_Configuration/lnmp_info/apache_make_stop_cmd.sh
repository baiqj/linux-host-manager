...
LINE_NUM=`grep  -n  "Apache_Make_Stop_Cmd"   $ENV_PATH  |  awk -F:  '{print $1}'`

#在"Apache_Make_Stop_Cmd"行之后添加一行

sed  -ie  "/Apache_Make_Stop_Cmd/a \'Apache_Make_Stop_Cmd\':\'"'$CMD -k  stop'"\'"   $ENV_PATH

#删除原来的"Apache_Make_Stop_Cmd"行

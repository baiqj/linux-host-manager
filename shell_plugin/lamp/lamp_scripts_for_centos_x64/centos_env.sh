...
for packages in patch make mlocate cmake gcc gcc-c++ gcc-g77 flex bison file libtool libtool-libs  kernel-devel libjpeg libjpeg-devel libpng libpng-devel libpng10 libpng10-devel gd gd-devel freetype freetype-devel libxml2  autoconf libxml2-devel zlib zlib-devel glib2 glib2-devel bzip2 bzip2-devel libevent libevent-devel ncurses ncurses-devel curl curl-devel e2fsprogs e2fsprogs-devel krb5 krb5-devel libidn libidn-devel openssl openssl-devel vim-minimal nano fonts-chinese gettext gettext-devel ncurses-devel gmp-devel pspell-devel unzip libcap pcre-devel openssl-devel libxml2-devel  mysql-devel bzip2-devel libmcrypt-devel libpng-devel libjpeg-turbo-devel  net-snmp-devel openldap-devel libcurl-devel libc-client-devel libtidy-devel;

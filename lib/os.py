...
****************************************
1、1检测是否包含除root外，UID=0的账号
****************************************

文件：os.py
函数：检测类： find_uid_0
支持的操作系统：
函数功能描述：检测系统中是否包含有具有uid=0的非root用户
输入参数：无
...
****************************************
1、2检测系统中权限为777的文件和目录
****************************************

文件：os.py
函数：检测类：  find_file_777
支持的操作系统：
...
find   /   -perm   -777
备注：有些目录中的文件是系统的临时文件，没什么意义，如 /proc   /sys/   /dev
...
支持的操作系统：
函数功能描述：检测系统的类型、版本及架构
输入参数：无
输出参数：操作系统名称，版本号 架构  CentOS 5.8 x64（示例）
函数实现方式描述：查看/etc/issue文件中是否包含centos或ubuntu等关键字
...
********************************************************************
2、5检测是否安装了基本工具软件，如果没有安装的话，则rpm或apt-get安装
********************************************************************
